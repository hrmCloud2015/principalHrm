...

{
...

    {
        ...
        $file = new Element\File('image-file2');
        ...
        $file = new Element\File('image-file3');
        ...
        $file = new Element\File('image-file4');
...
//        $select->setAttribute('class', "chosen-select"); 
        ...
        $select = new Element\Select('idHbbies');
       ...
       //Consecuencias
        ...
        $select->setValueOptions(array('0'=>'Si' , 
